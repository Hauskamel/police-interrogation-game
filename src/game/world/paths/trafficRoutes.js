...
export function createStreetbayPullOverRoute(startPosition) {
    ...
    const bayStop = new THREE.Vector3(STREETBAY_ENTRY_1[0] - 7, STREETBAY_ENTRY_1[1], STREETBAY_ENTRY_1[2] - 2.4);
