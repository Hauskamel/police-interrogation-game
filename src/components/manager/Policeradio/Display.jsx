...
export function Display () {
    ...
    function onKeyDown (e) {
        ...
        switch (keyCode) {
            case 38:
                setActiveOptionIndex(activeOptionIndex > 0 ? activeOptionIndex - 1 : radioDisplayContent.length - 1)
            break;

            case 40:
                setActiveOptionIndex(activeOptionIndex < radioDisplayContent.length-1 ? activeOptionIndex + 1 : 0)
            break;
        }
    };
