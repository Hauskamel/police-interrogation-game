...
const manipulations = [
    ...
    profile => ({
        ...profile,
         firstName: faker.helpers.arrayElement(imageProfile.firstNames)
    }),
    profile => ({
        ...profile,
...
// TODO:
// ES MÜSSEN EINIGE VARIABLEN GLOBAL GESETZT WERDEN, DA SIE ÜBERGREIFEND VERWENDET WERDEN
// in: 'generateDriverProfile'
// & in: 'manipulations:'
