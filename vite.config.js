  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'src/game/inspections/dialogue/discrepancyDialogueProvider.js',
        'src/game/inspections/utils/evaluateInspection.js',
        'src/game/inspections/utils/resolveDiscrepancySelection.js',
        'src/game/inspections/utils/selectNextControlScenario.js',
        ...
        'src/game/traffic/utils/getControlScenarioGenerationOptions.js',
        'src/game/traffic/utils/getUnavailableControlScenarioTypes.js',
        'src/stores/commitTrafficEntityRecords.js',
        'src/stores/controlScenarioStore.js',
